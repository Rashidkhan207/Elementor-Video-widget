...
return function(n,i){return function(e,t){if(S(e),!m(t)&&null!==t)throw TypeError("Can't set "+String(t)+" as a prototype")}(n,i),t?e.call(n,i):n.__proto__=i,n}}():void 0),Qt=Pe("iterator"),Xt=Wt.IteratorPrototype,Jt=Wt.BUGGY_SAFARI_ITERATORS,Zt=function(){return this},en=function(e,t,n,i,r,a,o){$t(n,t,i);var s,l,c,u=function(e){if(e===r&&m)return m;if(!Jt&&e in d)return d[e];switch(e){case "keys":case "values":case "entries":return function(){return new n(this,e)}}
return function(){return new n(this)}},h=t+" Iterator",f=!1,d=e.prototype,p=d[Qt]||d["@@iterator"]||r&&d[r],m=!Jt&&p||u(r),g="Array"==t&&d.entries||p;if(g&&(s=Ht(g.call(new e)),Xt!==Object.prototype&&s.next&&(Ht(s)!==Xt&&(Gt?Gt(s,Xt):"function"!=typeof s[Qt]&&x(s,Qt,Zt)),Ie(s,h,!0))),"values"==r&&p&&"values"!==p.name&&(f=!0,m=function(){return p.call(this)}),d[Qt]!==m&&x(d,Qt,m),Ut[t]=m,r)
if(l={values:u("values"),keys:a?m:u("keys"),entries:u("entries")},o)
...
Vl(a,!0),Vl(i,!1),qc.focusFirstMenuItem.call(this,i,n)}},setDownloadUrl:function(){var e=this.elements.buttons.download;xl.element(e)&&e.setAttribute("href",this.download)},create:function(e){var t=this,n=qc.bindMenuItemShortcuts,i=qc.createButton,r=qc.createProgress,a=qc.createRange,o=qc.createTime,s=qc.setQualityMenu,l=qc.setSpeedMenu,c=qc.showMenuPanel;this.elements.controls=null,this.config.controls.includes("play-large")&&this.elements.container.appendChild(i.call(this,"play-large"));var u=Ul("div",Hl(this.config.selectors.controls.wrapper));this.elements.controls=u;var h={class:"plyr__controls__item"};return uc(this.config.controls).forEach(function(s){if("restart"===s&&u.appendChild(i.call(t,"restart",h)),"rewind"===s&&u.appendChild(i.call(t,"rewind",h)),"play"===s&&u.appendChild(i.call(t,"play",h)),"fast-forward"===s&&u.appendChild(i.call(t,"fast-forward",h)),"progress"===s){var l=Ul("div",{class:"".concat(h.class," plyr__progress__container")}),f=Ul("div",Hl(t.config.selectors.progress));if(f.appendChild(a.call(t,"seek",{id:"plyr-seek-".concat(e.id)})),f.appendChild(r.call(t,"buffer")),t.config.tooltips.seek){var d=Ul("span",{class:t.config.classNames.tooltip},"00:00");f.appendChild(d),t.elements.display.seekTooltip=d}
t.elements.progress=f,l.appendChild(t.elements.progress),u.appendChild(l)}
if("current-time"===s&&u.appendChild(o.call(t,"currentTime",h)),"duration"===s&&u.appendChild(o.call(t,"duration",h)),"mute"===s||"volume"===s){var p=t.elements.volume;if(xl.element(p)&&u.contains(p)||(p=Ul("div",Ol({},h,{class:"".concat(h.class," plyr__volume").trim()})),t.elements.volume=p,u.appendChild(p)),"mute"===s&&p.appendChild(i.call(t,"mute")),"volume"===s){var m={max:1,step:.05,value:t.config.volume};p.appendChild(a.call(t,"volume",Ol(m,{id:"plyr-volume-".concat(e.id)})))}}
if("captions"===s&&u.appendChild(i.call(t,"captions",h)),"settings"===s&&!xl.empty(t.config.settings)){var g=Ul("div",Ol({},h,{class:"".concat(h.class," plyr__menu").trim(),hidden:""}));g.appendChild(i.call(t,"settings",{"aria-haspopup":!0,"aria-controls":"plyr-settings-".concat(e.id),"aria-expanded":!1}));var v=Ul("div",{class:"plyr__menu__container",id:"plyr-settings-".concat(e.id),hidden:""}),y=Ul("div"),b=Ul("div",{id:"plyr-settings-".concat(e.id,"-home")}),w=Ul("div",{role:"menu"});b.appendChild(w),y.appendChild(b),t.elements.settings.panels.home=b,t.config.settings.forEach(function(i){var r=Ul("button",Ol(Hl(t.config.selectors.buttons.settings),{type:"button",class:"".concat(t.config.classNames.control," ").concat(t.config.classNames.control,"--forward"),role:"menuitem","aria-haspopup":!0,hidden:""}));n.call(t,r,i),Ll(r,"click",function(){c.call(t,i,!1)});var a=Ul("span",null,Lc(i,t.config)),o=Ul("span",{class:t.config.classNames.menu.value});o.innerHTML=e[i],a.appendChild(o),r.appendChild(a),w.appendChild(r);var s=Ul("div",{id:"plyr-settings-".concat(e.id,"-").concat(i),hidden:""}),l=Ul("button",{type:"button",class:"".concat(t.config.classNames.control," ").concat(t.config.classNames.control,"--back")});l.appendChild(Ul("span",{"aria-hidden":!0},Lc(i,t.config))),l.appendChild(Ul("span",{class:t.config.classNames.hidden},Lc("menuBack",t.config))),Ll(s,"keydown",function(e){37===e.which&&(e.preventDefault(),e.stopPropagation(),c.call(t,"home",!0))},!1),Ll(l,"click",function(){c.call(t,"home",!1)}),s.appendChild(l),s.appendChild(Ul("div",{role:"menu"})),y.appendChild(s),t.elements.settings.buttons[i]=r,t.elements.settings.panels[i]=s}),v.appendChild(y),g.appendChild(v),u.appendChild(g),t.elements.settings.popup=v,t.elements.settings.menu=g}
if("pip"===s&&rc.pip&&u.appendChild(i.call(t,"pip",h)),"airplay"===s&&rc.airplay&&u.appendChild(i.call(t,"airplay",h)),"download"===s){var k=Ol({},h,{element:"a",href:t.download,target:"_blank"}),T=t.config.urls.download;!xl.url(T)&&t.isEmbed&&Ol(k,{icon:"logo-".concat(t.provider),label:t.provider}),u.appendChild(i.call(t,"download",k))}
"fullscreen"===s&&u.appendChild(i.call(t,"fullscreen",h))}),this.isHTML5&&s.call(this,cc.getQualityOptions.call(this)),l.call(this),u},inject:function(){var e=this;if(this.config.loadSprite){var t=qc.getIconUrl.call(this);t.cors&&Nc(t.url,"sprite-plyr")}
this.id=Math.floor(1e4*Math.random());var n=null;this.elements.controls=null;var i={id:this.id,seektime:this.config.seekTime,title:this.config.title},r=!0;xl.function(this.config.controls)&&(this.config.controls=this.config.controls.call(this,i)),this.config.controls||(this.config.controls=[]),xl.element(this.config.controls)||xl.string(this.config.controls)?n=this.config.controls:(n=qc.create.call(this,{id:this.id,seektime:this.config.seekTime,speed:this.speed,quality:this.quality,captions:Hc.getLabel.call(this)}),r=!1);var a,o=function(e){var t=e;return Object.entries(i).forEach(function(e){var n=Na(e,2),i=n[0],r=n[1];t=Ec(t,"{".concat(i,"}"),r)}),t};if(r&&(xl.string(this.config.controls)?n=o(n):xl.element(n)&&(n.innerHTML=o(n.innerHTML))),xl.string(this.config.selectors.controls.container)&&(a=document.querySelector(this.config.selectors.controls.container)),xl.element(a)||(a=this.elements.container),a[xl.element(n)?"insertAdjacentElement":"insertAdjacentHTML"]("afterbegin",n),xl.element(this.elements.controls)||qc.findElements.call(this),!xl.empty(this.elements.buttons)){var s=function(t){var n=e.config.classNames.controlPressed;Object.defineProperty(t,"pressed",{enumerable:!0,get:function(){return Wl(t,n)},set:function(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0];zl(t,n,e)}})};Object.values(this.elements.buttons).filter(Boolean).forEach(function(e){xl.array(e)||xl.nodeList(e)?Array.from(e).filter(Boolean).forEach(s):s(e)})}
if(nc.isEdge&&ec(a),this.config.tooltips.controls){var l=this.config,c=l.classNames,u=l.selectors,h="".concat(u.controls.wrapper," ").concat(u.labels," .").concat(c.hidden),f=Yl.call(this,h);Array.from(f).forEach(function(t){zl(t,e.config.classNames.hidden,!1),zl(t,e.config.classNames.tooltip,!0)})}}};function Dc(e){var t=e;if(!(arguments.length>1&&void 0!==arguments[1])||arguments[1]){var n=document.createElement("a");n.href=t,t=n.href}
try{return new URL(t)}catch(e){return null}}
function Bc(e){var t=new URLSearchParams;return xl.object(e)&&Object.entries(e).forEach(function(e){var n=Na(e,2),i=n[0],r=n[1];t.set(i,r)}),t}
var Hc={setup:function(){if(this.supported.ui)
...
var i=uc((navigator.languages||[navigator.language||navigator.userLanguage||"en"]).map(function(e){return e.split("-")[0]})),r=(this.storage.get("language")||this.config.captions.language||"auto").toLowerCase();if("auto"===r)r=Na(i,1)[0];var a=this.storage.get("captions");if(xl.boolean(a)||(a=this.config.captions.active),Object.assign(this.captions,{toggled:!1,active:a,language:r,languages:i}),this.isHTML5){var o=this.config.captions.update?"addtrack removetrack":"removetrack";Ll.call(this,this.media.textTracks,o,Hc.update.bind(this))}
setTimeout(Hc.update.bind(this),0)}},update:function(){var e=this,t=Hc.getTracks.call(this,!0),n=this.captions,i=n.active,r=n.language,a=n.meta,o=n.currentTrackNode,s=Boolean(t.find(function(e){return e.language===r}));this.isHTML5&&this.isVideo&&t.filter(function(e){return!a.get(e)}).forEach(function(t){e.debug.log("Track added",t),a.set(t,{default:"showing"===t.mode}),t.mode="hidden",Ll.call(e,t,"cuechange",function(){return Hc.updateCues.call(e)})}),(s&&this.language!==r||!t.includes(o))&&(Hc.setLanguage.call(this,r),Hc.toggle.call(this,i&&s)),zl(this.elements.container,this.config.classNames.captions.enabled,!xl.empty(t)),(this.config.controls||[]).includes("settings")&&this.config.settings.includes("captions")&&qc.setCaptionsMenu.call(this)},toggle:function(e){var t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1];if(this.supported.ui){var n=this.captions.toggled,i=this.config.classNames.captions.active,r=xl.nullOrUndefined(e)?!n:e;if(r!==n){if(t||(this.captions.active=r,this.storage.set({captions:r})),!this.language&&r&&!t){var a=Hc.getTracks.call(this),o=Hc.findTrack.call(this,[this.captions.language].concat(ja(this.captions.languages)),!0);return this.captions.language=o.language,void Hc.set.call(this,a.indexOf(o))}
this.elements.buttons.captions&&(this.elements.buttons.captions.pressed=r),zl(this.elements.container,i,r),this.captions.toggled=r,qc.updateSetting.call(this,"captions"),Nl.call(this,this.media,r?"captionsenabled":"captionsdisabled")}}},set:function(e){var t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=Hc.getTracks.call(this);if(-1!==e)
if(xl.number(e))
if(e in n){if(this.captions.currentTrack!==e){this.captions.currentTrack=e;var i=n[e],r=(i||{}).language;this.captions.currentTrackNode=i,qc.updateSetting.call(this,"captions"),t||(this.captions.language=r,this.storage.set({language:r})),this.isVimeo&&this.embed.enableTextTrack(r),Nl.call(this,this.media,"languagechange")}
